...
from src.mmd import MMDKernel

from .enums import AggregatorType, DiscriminatorLoss, DiscriminatorMethod, EvalTrainData
...
class ASMConf:
    ...
    pred_y_hidden_dim: Optional[List[int]] = None
