...
from src.configs.classes import ASMConf, DiscriminatorMethod, LoggingConf, MiscConf
from src.data import DataModule
from src.io import restore_model, save_model
...
class AdvSemiSupervisedAlg(Algorithm):
    ...
    def _build_predictors(
        ...
        if self.alg_cfg.pred_y_loss_w > 0:
            model, _ = Fcn(hidden_dim=self.alg_cfg.pred_y_hidden_dim,)(
        ...
        if self.alg_cfg.pred_s_loss_w > 0:
            model, _ = Fcn(
                ...
                final_bias=self.alg_cfg.s_pred_with_bias,
