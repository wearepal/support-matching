...
class SetFcn(PredictorFactory):
    ...
    def __call__(
        ...
        aggregator, input_dim = self._aggregator(input_dim=input_dim, batch_size=batch_size)
        fcn_post, target_dim = self._post_agg_fcn(input_dim=input_dim, target_dim=target_dim)
