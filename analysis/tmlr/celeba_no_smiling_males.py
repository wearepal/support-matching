...
data = download_groups(
    wandb,
    group_mapping={
        "celeba.SupportMatching.balanced-False.new_ae_arch_more_iters.no_smiling_males": Group(
        ...
        "celeba.gdro.context_mode_cluster_labels.cluster_and_gdro.real_gdro.no_smiling_males": Group(
