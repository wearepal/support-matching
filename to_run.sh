...
run_balanced data=adult/gender bias=adult/missing_demo enc=adult fdm=adult/on_enc_with_bags_4 clust=adult fdm.batch_size=64 fdm.bag_size=8 misc.exp_group=bg4-with-8 misc.seed="range(0,30)" hydra/launcher=ray_0.33gpus
...
run_unbalanced data=adult/gender bias=adult/missing_demo enc=adult fdm=adult/on_enc_with_bags_4 clust=adult fdm.batch_size=16 fdm.bag_size=32 misc.exp_group=bg4-with-32 misc.seed="range(0,30)" hydra/launcher=ray_0.33gpus
